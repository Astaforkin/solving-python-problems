...
def task3_2():
    num = input().split()
    num[:-1:2], num[1::2] = num[1::2], num[:-1:2]
    print(*num)
...
def task6_2():
    numbers, multiply, result = [int(input()) for i in range(int(input()))], int(input()), 'НЕТ'
...
#8. Камень, ножницы, бумага, ящерица, Спок 🌶️
...
#11. Роскомнадзор запретил букву а 🌶️🌶️
